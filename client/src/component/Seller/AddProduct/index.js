...
class AddProductIndex extends Component {
      ...
      <div>
        ...
        <div className="col-sm-12 col-md-12 col-lg-12 float-left">
          <div className="content-wrapper" >
            ...
            <AddProductForm ProductId={this.props.match.params.id} />
...
export default connect(mapStateToProps, mapDispatchToProps)(AddProductIndex);
